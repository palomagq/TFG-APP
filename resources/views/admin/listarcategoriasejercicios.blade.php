        ...
        <div class="col-12">
            ...
            <div class="card mt-2">
                <div class="card-header">
                    <h3 class="card-title">Listado de Categorías de Ejercicios</h3>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="min-width: 650px">
            ...
            <div class="modal-body" style=" margin-top: -2em;">
                ...
                <form action="{{route('insertdataCategoriaEjercicios')}}" method="POST" name="createCategoria" id="myform">
                    @csrf
                    <hr>
...
$(document).ready( function () {
         ...
         var datatable = $('#table_id').DataTable({
             ...
             ajax: {
                 url: "{{route('selectdataCategoriaEjercicios')}}",
                 type: 'post',
                 data: {
         ...
         $('#table_id tbody').on('click', 'tr', function () {
             ...
             $.ajax({
                 url: "{{route('getEditarDataCategoriaEjercicios')}}",
                 type: "POST",
                 cache: false,
                 data:{
                     _token:'{{ csrf_token() }}',
         ...
         $("#DeleteDataButton").click(function(){
             $.ajax({
                 url: "{{route('deletedataCategoriaEjercicios')}}",
                 type: "POST",
                 cache: false,
                 data:{
                     _token:'{{ csrf_token() }}',
         ...
         $("#insertDataButton").click(function(){
             ...
             $.ajax({
                 url: "{{route('insertdataCategoriaEjercicios')}}",
                 type: "POST",
                 cache: false,
                 data:{
                     _token:'{{ csrf_token() }}',
         ...
         $("#updateDataButton").click(function(){
             $.ajax({
                 url: "{{route('updatedataCategoriaEjercicios')}}",
                 type: "POST",
                 cache: false,
                 data:{
                     _token:'{{ csrf_token() }}',
