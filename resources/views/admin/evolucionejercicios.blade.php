        ...
        <div class="col-12">
            ...
            <div class="card mt-2">
                <div class="card-header">
                    <h3 class="card-title">Evolución de los Ejercicios</h3>
                </div>

            <div class="card-body">
                <form action="{{route('EvolucionEjercicio')}}" name="adminEvolucion" method="GET">
                    @csrf
                    <div class="form-group row">
                        ...
                        <input class="form-control form-control-border border-width-2 col-md-3" type="date" placeholder="Fecha Entrenamiento" name="fecha" 
                            value="@php if(session::has('fecha')==0) echo date('Y-m-d'); else echo str_replace("'","",session('fecha')); @endphp" 
...
@section('modal')
 ...
 <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createTitle" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
        <h1>Insertar datos de la Evolución de Ejercicios</h1>
                    ...
                    <div class="form-row row">
                        <div class="form-group col-md-6">
                            <div class="row">
                                ...
                                <input class="form-control form-control-border border-width-2 col-md-8" type="number" placeholder="Series" name="series" id="series" required>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <div class="row">
                                <label style="font-size:13px" for="repeticiones"><b>Repeticiones</b></label>
                                <input class="form-control form-control-border border-width-2 col-md-8" type="number" placeholder="Repeticiones" name="repeticiones" id="repeticiones" >                                   
                            </div>
                        </div>                           
                    </div>
                    <div class="form-row row">
                        ...
                        <div class="form-group col-md-6">
                            <div class="row">
                                ...
                                <input class="form-control form-control-border border-width-2 col-md-8" type="number" placeholder="Peso" name="peso" id="peso" >                                   
                            </div>
                        </div> 
                    </div>
 ...
 <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="createTitle" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
        <h1>Actualizar datos de la Evolución de Ejercicios</h1>
        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
        </div>
                ...
                <div class="card-body" style="padding: 0;">
                    ...
                    <div class="form-row row">
                        <div class="form-group col-md-6">
                            <div class="row">
                                <label style="font-size:13px" for="series"><b>Series</b></label>
                                <input class="form-control form-control-border border-width-2 col-md-8" type="number" placeholder="Series" name="seriesEditar" id="seriesEditar" required>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <div class="row">
                                <label style="font-size:13px" for="repeticiones"><b>Repeticiones</b></label>
                                <input class="form-control form-control-border border-width-2 col-md-8" type="number" placeholder="Repeticiones" name="repeticionesEditar" id="repeticionesEditar" >                                   
                            </div>
                        </div>                           
                    </div>
                    <div class="form-row row">
                        <div class="form-group col-md-6">
                            <div class="row">
                                <label style="font-size:13px" for="distancia"><b>Distancia</b></label>
                                <input class="form-control form-control-border border-width-2 col-md-8" type="number" placeholder="Distancia" name="distanciaEditar" id="distanciaEditar" >                                   
                            </div>
                        </div> 
                        <div class="form-group col-md-6">
                            <div class="row">
                                <label style="font-size:13px" for="peso"><b>Peso</b></label>
                                <input class="form-control form-control-border border-width-2 col-md-8" type="number" placeholder="Peso" name="pesoEditar" id="pesoEditar" >                                   
                            </div>
                        </div> 
                    </div>
...
$(document).ready( function () {
    ...
    //datatable
      ...
      var datatable = $('#table_id_1').DataTable({
             ...
             ajax: {
                 url: "{{route('selectdataEvolucionEjercicios_tabla1')}}",
                 type: 'post',
                 data: {
      ...
      var datatable2 = $('#table_id_2').DataTable({
             ...
             ajax: {
                 url: "{{route('selectdataEvolucionEjercicios_tabla2')}}",
                 type: 'post',
                 data: {
                     "_token": $("meta[name='csrf-token']").attr("content")
                 },
        ...
        $("#createDataButton").click(function(){
            $.ajax({
                url: "{{route('insertdataEvolucionEjercicio')}}",
                type: "POST",
                cache: false,
                data:{
                    _token:'{{ csrf_token() }}',
        ...
        $('#table_id_2 tbody').on('click', 'tr', function () {
            ...
            console.log(data2)
            $.ajax({
                url: "{{route('getEditarDataEvolucionEjercicio')}}",
                type: "POST",
                cache: false,
                data:{
                    _token:'{{ csrf_token() }}',
        ...
        $("#updateDataButton2").click(function(){
            ...
            $.ajax({
                url: "{{route('updatedataEvolucionEjercicio')}}",
                type: "POST",
                cache: false,
                data:{
                    _token:'{{ csrf_token() }}',
