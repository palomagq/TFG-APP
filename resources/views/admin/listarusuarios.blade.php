    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="min-width: 650px">
            ...
            <div class="modal-body" style=" margin-top: -2em;">
                ...
                <form action="{{route('insertdata')}}" method="POST" name="createUser"> <!--onsubmit = "return validaedad(document.getElementById('fechanaci').value)"-->
                    @csrf
                    <hr>
    ...
    $(document).ready( function () {
        ...
        var datatable = $('#table_id').DataTable({
           ...
           /* columnDefs: [
            ...
            columns: [{ data: "nombre" }, { data: "apellidos" }, { data: "dni" }, { data: "usersname" }, { data: "sexo_nombre" },{ data: "email" },{ data: "telefono" },{ data: "fechaNac", render: DataTable.render.datetime( 'D/M/YYYY' ) }, { data: "name" }, { data: "nombregimnasio_localidad" } ],
        });
