        ...
        <div class="col-12">
            ...
            <div class="card mt-2">
                <div class="card-header">
                    <h3 class="card-title">Listado de Recepción</h3>
                </div>
...
@section('modal')
 ...
 <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="min-width: 650px">
            ...
            <h1>Añadir Nuevo Recepcionista</h1>
            ...
            <div class="modal-body" style=" margin-top: -2em;">
                ...
                <form action="{{route('insertdataRecepcion')}}" method="POST">
                    @csrf
                    <hr>
                            ...
                            <div class="form-group col-md-6">
                                <div class="row">
                                    ...
                                    <!--<input class="form-control form-control-border border-width-2 col-md-6" type="number" placeholder="Sexo" name="sexo" id="sexo" required>-->
                                        <select class="js-example-responsive js-example-placeholder-single js-states form-control col-md-6" name="id_selected_sexo" id="id_selected_sexo" required>
                                           <!-- <optgroup label="Sexo">-->
                                            <option value=""></option>
 ...
 <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateTitle" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
        <h1>Actualizar datos de Recepcionista</h1>
...
<script>
    ...
    $(document).ready( function () {
        ...
        var datatable = $('#table_id').DataTable({
            ...
            ajax: {
                url: "{{route('selectdataRecepcion')}}",//'php/identidades.php',
                type: 'post',
                data: {
        ...
        @if((Session('idRole') != 5) && (Session('idRole') != 4) && (Session('idRole') != 3))
            var data = null
            $('#table_id tbody').on('click', 'tr', function () {
                ...
                $.ajax({
                    url: "{{route('getEditarDataRecepcion')}}",
                    type: "POST",
                    cache: false,
                    data:{
                        _token:'{{ csrf_token() }}',
