                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="overflow-wrap: break-word; word-break: break-word; padding: 10px; font-family: 'Lato', sans-serif;" align="left">
                                                                <div style="font-family: 'Pacifico', cursive; font-size: 33px; font-weight: 400; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                    <p style="line-height: 140%;">FitEnerGym</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                            ...
                                                            <td style="overflow-wrap: break-word; word-break: break-word; padding: 0px 10px 30px; font-family: 'Lato', sans-serif;" align="left">
                                                                <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 140%; text-align: center;">
                                                                        <span style="font-size: 28px; line-height: 39.2px; color: #ffffff; font-family: Lato, sans-serif;">Por favor, recupere su contraseña</span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    ...
                                                                    <p style="line-height: 140%;">
                                                                        <span style="font-size: 18px; line-height: 25.2px;">
                                                                            Le hemos enviado este correo electrónico en respuesta a su solicitud de restablecer su contraseña en el nombre de la empresa.
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 140%;"></p>
                                                                    <p style="line-height: 140%;">
                                                                        <br />
                                                                        <span style="font-size: 18px; line-height: 25.2px;">Su nueva contraseña es la siguiente: </span>
                                                                        {{ $details['pass'] }}
                                                                    </p>
                                                                    <br />
                                                                    <p style="line-height: 140%;">
                                                                        <br />
                                                                        <span style="font-size: 18px; line-height: 25.2px;">Para ingresar con su nueva contraseña, por favor siga el siguiente enlace hacia el login de la página :</span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <span style="color: #888888; font-size: 14px; line-height: 19.6px;">
                                                                            <em><span style="font-size: 16px; line-height: 22.4px;">Ignore este correo electrónico si no solicitó un cambio de contraseña. </span></em>
                                                                        </span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                        ...
                                        <div style="height: 100%; width: 100% !important;">
                                            ...
                                            ><!--<![endif]-->
                                                <table style="font-family: 'Lato', sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td style="overflow-wrap: break-word; word-break: break-word; padding: 0px 0px 6px; font-family: 'Lato', sans-serif;" align="left">
                                                                <div style="font-size: 14px; line-height: 140%; text-align: justify; word-wrap: break-word;">
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px; color: #ecf0f1;">info@fitenergym.es</span></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                        ...
                                        <div style="height: 100%; width: 100% !important;">
                                            ...
                                            ><!--<![endif]-->
                                                <table style="font-family: 'Lato', sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td style="overflow-wrap: break-word; word-break: break-word; padding: 0px 0px 10px 6px; font-family: 'Lato', sans-serif;" align="left">
                                                                <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    <p style="line-height: 140%; font-size: 14px;"></p>
                                                                    <p style="line-height: 140%; font-size: 14px; margin-top:1.4em;">
                                                                        <span style="font-size: 14px; line-height: 19.6px;">
                                                                            <span style="color: #ecf0f1; font-size: 14px; line-height: 19.6px;"><span style="line-height: 19.6px; font-size: 14px;">Company ©  All Rights Reserved</span></span>
                                                                        </span>
                                                                    </p>
                                                                </div>
                                                            </td>
